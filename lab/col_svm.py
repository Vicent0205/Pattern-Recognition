...
class col_svm:  
    def __init__(self,C=10,features=600,sigma_sq=0.1,kernel="gaussian"):
        ...
        self.svm0.fit(x0,y0,epochs=20,print_every_nth_epoch=2,learning_rate=0.01)
        ...
        self.svm1.fit(x1,y1,epochs=20,print_every_nth_epoch=2,learning_rate=0.01)
        ...
        self.svm2.fit(x2,y2,epochs=20,print_every_nth_epoch=2,learning_rate=0.01)
