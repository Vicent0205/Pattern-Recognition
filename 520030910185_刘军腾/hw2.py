"""
This file is to iii) question.
click run in vscode or pycharm is ok
The result is n=100 and various m value from 120,200,300,500
"""
...
def train(x_train,y_train,x_valid,y_valid,tempW,gama):
    ...
    #valid_num.append(valid_index)
    #valid_index+=1
    #valid_loss.append(regular+diff_loss)
